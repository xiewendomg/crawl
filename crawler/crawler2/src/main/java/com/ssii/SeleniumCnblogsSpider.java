...
public class SeleniumCnblogsSpider implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        downloader= new SeleniumDownloader("D:/Chromedriver.exe_for_Windows_7_64_bit.exe");
        //downloader.setThread(10);
        Spider.create(new SeleniumCnblogsSpider()).setDownloader(downloader).addUrl("http://www.data5u.com/free/gngn/index.shtml").addPipeline(new ConsolePipeline()).thread(10).runAsync();
    }
}